    ...
    class Student : Person, IComparable<Student>
    {
        ...
        public bool setName(string input)
        {
            ...
            if (input.Length < 2)
            {
                ...
                Console.WriteLine("Name must have more than two letters!");
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Student> students = new List<Student>
                {
                  new Student("Admir","Bajric","Tuzla","admirbajric@gmail.com"),
                  new Student("Samed","Aljic","Tuzla","drogba@gmail.com"),
                  new Student("Admira","Ascic","Sarajevo","atka@gmail.com"),
                  new Student("Jusuf","Mehmedovic","Tuzla","juso@gmail.com"),
                  new Student("Mirsad","Nukic","Sarajevo","Mirso@gmail.com"),
                };
            students.Sort();
